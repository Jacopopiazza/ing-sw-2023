...
public class DifferentLinesTest extends TestCase {
    ...
    public void setUp() throws NoTileException, IllegalColumnInsertionException {
        ...
        trueMatrix = gson.fromJson(obj.get("testTrueDifferentLines"), TileColor[][].class);
        falseMatrix = gson.fromJson(obj.get("testFalseDifferentLines"), TileColor[][].class);
    ...
    public void testCheck() {
        DifferentLines test = new DifferentLines(2);
